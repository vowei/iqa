var protractor = require('C:\\Users\\changlli\\AppData\\Roaming\\npm\\node_modules\\protractor')
  , webdriver = require('C:\\Users\\changlli\\AppData\\Roaming\\npm\\node_modules\\selenium-webdriver');
...
var productListTest = function() {
    ...
    this.Then(/^the first product is (\\w+) S$/, function (result, next) {
        next();
    });
}
